...
const PRESET_CLASSES: WellnessClass[] = [
  {
    id: 'class-1',
    title: 'Anti-Inflammatory Nutritional Coaching',
    category: 'nutrition',
    ...
    totalSeats: 15,
    availableSeats: 5,
    description: 'Learn physiological meal planning, anti-inflammatory Omega-3 diets, and identifying systemic food triggers.',
    intensityLevel: 'Educational'
  },
  {
    id: 'class-2',
    title: 'Hand & Finger Joint Resistance Exercises',
    category: 'mobility',
    time: '10:00 AM - 11:00 AM',
    date: 'Thursday, June 4',
    duration: '60 mins',
    instructor: 'Michelle Alwayson',
    instructorSpecialty: 'Physiotherapist',
    room: 'Clinical Gym 1',
    totalSeats: 10,
    availableSeats: 3,
    description: 'Structured exercises calibrated for inflammatory polyarthritis. Focuses on hand grip strength, finger tendon gliding, and wrist ROM.',
    intensityLevel: 'Moderate'
  },
  {
    id: 'class-3',
    title: 'Mindfulness & Autoimmune Pain Management',
    category: 'mindfulness',
    time: '4:00 PM - 5:00 PM',
    date: 'Friday, June 5',
    duration: '60 mins',
    instructor: 'Dr. G. Theogate',
    instructorSpecialty: 'Rheumatology',
    room: 'Digital Telehealth Suite',
    totalSeats: 50,
    availableSeats: 34,
    description: 'Evidence-based cognitive breathing methodologies designed to regulate cortisol levels, inflammatory pain symptoms, and improve restful sleep patterns.',
    intensityLevel: 'Gentle'
  },
  {
    id: 'class-4',
    title: 'Omega-3 and Antioxidant Label Mastery',
    category: 'nutrition',
    ...
    totalSeats: 20,
    availableSeats: 12,
    description: 'Hands-on clinical guide to deciphering serving labels, antioxidant counting, and designing a rheumatology-supportive diary.',
    intensityLevel: 'Educational'
  },
  {
    id: 'class-5',
    title: 'Hydrotherapy Postures for Symmetrical Polyarthritis',
    category: 'mobility',
    ...
    instructor: 'Michelle Alwayson',
    instructorSpecialty: 'Physiotherapist',
    room: 'Allied Hydrotherapy Pool',
    totalSeats: 12,
    availableSeats: 4,
    description: 'Gentle warmth-assisted aquatic exercises to maintain flexibility, build cardiovascular strength, and decompression of hand and wrist joints.',
    intensityLevel: 'Gentle'
  },
  {
    id: 'class-6',
    title: 'Neurological Rest & Cognitive Recovery',
    category: 'mindfulness',
    ...
    totalSeats: 100,
    availableSeats: 72,
    description: 'Formal clinical seminar reviewing autonomic nervous system reset mechanisms and daily chronic joint recovery adaptations.',
    intensityLevel: 'Educational'
  }
];
