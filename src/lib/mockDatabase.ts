...
const INITIAL_DB: MockDb = {
  ...
  reminders: [],
  messages: [
    { id: 'msg-001', senderId: 'uid-patient-001', senderName: 'Marcus Everett', recipientId: 'uid-clinician-001', recipientName: 'Dr. Gregory Theogate, MD', body: 'Hello Dr. Theogate, I am seeking a refill of my Folic Acid 5mg prescription. The current active course is going very well.', read: false, createdAt: '2025-05-20T08:00:00Z', status: 'sent' }
  ],
  audit_logs: [],
  sops: [],
  charges: [],
